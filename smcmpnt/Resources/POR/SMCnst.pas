...
const
  ...
  strErrSaveChanges = 'Não foi possível guardar os dados! Verifique a ligação ao servidor e a validação dos dados.';
  strDeleteWarning = 'Pretende mesmo eliminar a tabela %s?';
  strEmptyWarning = 'Pretende eliminar o conteúdo da tabela %s?';
...
const //for EditTyped
  ...
  SNextMonth = 'mês seguinte';
  SNextYear = 'ano seguinte'; 
